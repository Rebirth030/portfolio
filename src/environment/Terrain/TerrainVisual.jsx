...
export default function TerrainVisual() {
    const { terrainMapTex, noiseTex, terrainPathTex, nodes, fogMaskTex } = useTerrainAssets()
    ...
    const terrainMaterial = useMemo(() => {
        const mask = texture(fogMaskTex, uv()).r
    ...
    // Wasser (nur Effekt-Overlay, durchsichtig)
    const uMinB = minBlue
    const uMaxB = maxBlue
    ...
    return (
        <>
            {/* Water overlay plane (nur Effekt) */}
            <mesh
                ref={planeRef}
